...
soundPackName = "UnrealTournament3"
soundPackLang = "Ita"

outputFile = "PVPSound_SoundLengthsUT3"& soundPackLang & ".lua"
...
function writeSound(outfile, path, album, timesec, timemillisec, title, artist)
	...
	elseif folder = "Test" then
		...
		if len(path) + 1 >= 0 and len(path) + 1 <= 4 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,																				duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 5 and len(path) + 1 <= 8 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,																			duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 9 and len(path) + 1 <= 12 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,																		duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 13 and len(path) + 1 <= 16 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,																	duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 17 and len(path) + 1 <= 20 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,																duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 21 and len(path) + 1 <= 24 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,															duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 25 and len(path) + 1 <= 28 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,														duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 29 and len(path) + 1 <= 32 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,													duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 33 and len(path) + 1 <= 36 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,												duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 37 and len(path) + 1 <= 40 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,											duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 41 and len(path) + 1 <= 44 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,										duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 45 and len(path) + 1 <= 48 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,									duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 49 and len(path) + 1 <= 52 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,								duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 53 and len(path) + 1 <= 56 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,							duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 57 and len(path) + 1 <= 60 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,						duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 61 and len(path) + 1 <= 64 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,					duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 65 and len(path) + 1 <= 68 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,				duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 69 and len(path) + 1 <= 72 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,			duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		elseif len(path) + 1 >= 73 and len(path) + 1 <= 76 then
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,		duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		else
			BinaryStream.WriteText soundPackTable & "[" & number & "]				=	{ dir = """ & realtiveSoundFolder & "" & path & """,	duration = " & timesec & "." & timemillisec & " }" & Vbcrlf
		end if
